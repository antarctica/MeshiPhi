...
is located at :code:`cartographi.Dataloaders/Scalar/myScalarDataloader.py`.
...
a list of files, and stored in params under the key 'files'::
   ...
   from cartographi.Dataloaders.Scalar.myScalarDataloader import myScalarDataloader
...
.. automodule:: cartographi.dataloaders.factory
   :members: